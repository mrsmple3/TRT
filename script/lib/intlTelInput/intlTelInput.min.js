		...
		var H = (l, t) => {
			...
			O = (l, t, e, i) => {
				if ((t && typeof t == "object") || typeof t == "function")
					for (let n of x(t)) !P.call(l, n) && n !== e && I(l, n, { get: () => t[n], enumerable: !(i = M(t, n)) || i.enumerable });
				return l;
			};
			...
			_ = class {
				...
				_init() {
					this.d.useFullscreenPopup && (this.d.fixDropdownWidth = !1),
						this.d.separateDialCode && ((this.d.allowDropdown = !0), (this.d.nationalMode = !1), (this.d.countrySearch = !0)),
						...
						this.d.separateDialCode &&
							(this.isRTL ? (this.originalPaddingRight = this.a.style.paddingRight) : (this.originalPaddingLeft = this.a.style.paddingLeft)),
				...
				_f() {
					...
					if ((this.a.parentNode?.insertBefore(p, this.a), t || i)) {
						(this.k = c("div", { class: "iti__country-container" }, p)),
							t
								...
								: (this.selectedCountry = c("div", { class: "iti__selected-country" }, this.k));
						let m = c("div", { class: "iti__selected-country-primary" }, this.selectedCountry);
						if (
							((this.l = c("div", null, m)),
							(this.selectedCountryA11yText = c("span", { class: "iti__a11y-text" }, this.l)),
							t && (this.u = c("div", { class: "iti__arrow", "aria-hidden": "true" }, m)),
							e && (this.t = c("div", { class: "iti__selected-dial-code" }, this.selectedCountry)),
							t)
						) {
							let C = r ? "" : "iti--flexible-dropdown-width";
							if (
								((this.dropdownContent = c("div", { id: `iti-${this.id}__dropdown-content`, class: `iti__dropdown-content iti__hide ${C}` })),
								h &&
									((this.searchInput = c(
										"input",
										{
									...
									(this.searchResultsA11yText = c("span", { class: "iti__a11y-text" }, this.dropdownContent))),
								(this.countryList = c(
									"ul",
									{ class: "iti__country-list", id: `iti-${this.id}__country-listbox`, role: "listbox", "aria-label": g.countryListAriaLabel },
									this.dropdownContent
								)),
								this._g(),
								h && this._p4(),
					...
					if ((p.appendChild(this.a), s)) {
						let m = this.a.getAttribute("name") || "",
							C = s(m);
						C.phone && ((this.hiddenInput = c("input", { type: "hidden", name: C.phone })), p.appendChild(this.hiddenInput)),
							C.country && ((this.hiddenInputCountry = c("input", { type: "hidden", name: C.country })), p.appendChild(this.hiddenInputCountry));
					}
				}
				_g() {
					for (let t = 0; t < this.p.length; t++) {
				...
				_v(t) {
					let e = t.indexOf("+"),
						i = e ? t.substring(e) : t,
						n = this.s.dialCode;
					i && n === "1" && i.charAt(0) !== "+" && (i.charAt(0) !== "1" && (i = `1${i}`), (i = `+${i}`)),
				...
				_z(t) {
					...
					if (((this.s = t ? this._y(t, !1) || {} : {}), this.s.iso2 && (this.j = this.s.iso2), this.l)) {
						let o = "",
							r = "";
						t && i ? ((o = `iti__flag iti__${t}`), (r = `${this.s.name} +${this.s.dialCode}`)) : ((o = "iti__flag iti__globe"), (r = n.noCountrySelected)),
							(this.l.className = o),
				...
				handleAutoCountry() {
					this.d.initialCountry === "auto" &&
						a.autoCountry &&
						((this.j = a.autoCountry), this.s.iso2 || this.l.classList.contains("iti__globe") || this.setCountry(this.j), this.h());
				}
				handleUtils() {
